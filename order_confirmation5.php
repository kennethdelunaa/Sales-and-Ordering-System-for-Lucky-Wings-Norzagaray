    ...
    <div class="container position-absolute top-50 start-50 translate-middle">
        <div class="card order_total shadow m-auto p-3 col-xxl-4 h-75">
                        ...
                        if(!empty($_POST["order"]))
                        {
                                ...
                                {   
                                    ...
                                    {   
                                        ...
                                        ('". trim($order, " ") ."', '".$order_num."','5','Pending')");
                                        mysqli_query($con,"INSERT INTO `table_5`(`orders`, `order_total` ,`table_num_order`, `status`) VALUES
                                        ('". trim($order, " ") ."', '".$order_num."','5','Pending')");
            ...
            <div class="col-12">
                ...
                <a type="button" name="submit" href="customer_side5.php?success" class="btn btn-dark">
                Done
                </a>
        </div>
    </div>
