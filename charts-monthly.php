                    ...
                    <script type="text/javascript">
                      ...
                      function drawChart() {
                        var data = google.visualization.arrayToDataTable([
                          ['Date', 'Sales', 'Expenses'],
                          <?php 
                          $query = "select MONTHNAME(date) as 'month',YEAR(date) as 'year',sale,expense from chart_table GROUP BY MONTH(date);";
                          ...
                          ?>
                          ['<?php echo $month. " "; echo $year?>' , <?php echo $sale?>, <?php echo $expenses?>],
                            <?php
                            }
                            ?>
                        ]);
