        ...
        <div class="card order_total shadow m-auto p-3 col-xxl-4 h-75">
            ...
            <div class="ord">
                ...
                if (isset($_POST['submit']) ) 
                {
                        ...
                        if(!empty($_POST["order"]))
                        {
                            ...
                            {   
                                ...
                                {   
                                    ...
                                    mysqli_query($con,"INSERT INTO `table_1`(`orders`, `order_total` ,`table_num_order`, `status`) VALUES
                                    ('". trim($order, " ") ."', '".$order_num."','1','Pending')");
                        ...
                        {
                            header("Location: customer_ordering1.php?empty=order");
                        }
                }
                ?>
            </div>
            <div class="col-12">
                ...
                <a type="button" name="submit" href="customer_side1.php?success" class="btn btn-dark">
                    Done
                </a>
        </div>
    </div>
